      ...
      <div className="docs-shell">
        ...
        <aside className="docs-sidebar">
          ...
          <div style={{ marginTop: 'auto', paddingTop: 24 }}>
            <button className="btn small" data-infinity-local-action="true" onClick={() => navigate('dashboard')} style={{ width: '100%' }}>
              ← Back to app
            </button>
          </div>
        </aside>
        ...
        <div className="docs-content">
          {article ? (
            <div className="docs-article">
              <button className="docs-back" data-infinity-local-action="true" onClick={() => setActiveArticle(null)}>
                ← {section.title}
              </button>
            ...
            <div className="docs-section">
              ...
              <div className="docs-article-list">
                {section?.articles.map((art, i) => (
                  ...
                  >
                    <div className="docs-article-icon" style={{ background: section.bg, color: section.color }}>
                      {i + 1}
                    </div>
                    <div>
...
const VIEW_TITLES = {
  ...
  docs: ['Documentation','Guides, API reference and feature walkthroughs'],
    ...
    <div className="app" data-theme={theme}>
      ...
      <main className="main">
        ...
        <div className="content">
          ...
          {view === 'docs' && <DocsView navigate={navigate} />}
